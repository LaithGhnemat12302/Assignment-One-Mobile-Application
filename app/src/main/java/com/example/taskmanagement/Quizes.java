...
public class Quizes extends AppCompatActivity {
    ...
    private void putGsonString(){   //This method is to put Gson String for ArrayList in the file
        ...
        editor.putString("quizes", testsString);   //Put Json String in the editor file
        editor.commit();    //Save changes
    }
    //_____________________________________________________________________________________________________________________________________

    private void fillLists() {  //Get values for the ArrayLists from the file
        String strTests = preference.getString("quizes", "");  //Get the string value from file
        String strFinishedTests = preference.getString("finishedQuizes", "");  //Get the string value from file
    ...
    private void setupViews() { //Setup the needed elements that we will need in this class
        ...
        examImage.setImageResource(R.drawable.quiz);
    ...
    public void btnOnClickFinish(View view) {    //To save the finished tests in the editor file
        ...
        editor.putString("finishedQuizes", finishedTestsString);   //Put Json String in the editor file
        editor.commit();    //Save changes
    ...
    public void btnOnClickLoad(View view) {     //To load the number of finished tests using preference and gson
        String str = preference.getString("finishedQuizes", "");  //Get the string value from file
