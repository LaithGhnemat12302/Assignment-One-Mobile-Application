...
public class wednesday_Schedule extends AppCompatActivity {
    ...
    private void putGsonString(){   //This method is to put Gson String for ArrayList in the file
        ...
        editor.putString("wednesdayLectures", daysString);   //Put Json String in the editor file
        editor.commit();    //Save changes
    }
    //_____________________________________________________________________________________________________________________________________

    private void fillLists() {  //Get values for the ArrayLists from the file
        String strLectures = preference.getString("wednesdayLectures", "");  //Get the string value from file
        String strFinishedLectures = preference.getString("finishedLecturesWednesday", "");  //Get the string value from file
    ...
    private void setupViews() { //Setup the needed elements that we will need in this class
        ...
        dayImage.setImageResource(R.drawable.wednesday);
    ...
    public void btnFinishedOnClickDay(View view) {    //To save the finished lectures in the editor file
        ...
        editor.putString("finishedLecturesWednesday", finishedLecturesString);   //Put Json String in the editor file
        editor.commit();    //Save changes
    ...
    public void btnLoadOnClickDay(View view) {     //To load the number of finished lectures using preference and gson
        String str = preference.getString("finishedLecturesWednesday", "");  //Get the string value from file
