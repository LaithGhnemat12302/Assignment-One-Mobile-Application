...
public class thursday_Schedule extends AppCompatActivity {
    ...
    private void putGsonString(){   //This method is to put Gson String for ArrayList in the file
        ...
        editor.putString("thursdayLectures", daysString);   //Put Json String in the editor file
        editor.commit();    //Save changes
    }
    //_____________________________________________________________________________________________________________________________________

    private void fillLists() {  //Get values for the ArrayLists from the file
        String strLectures = preference.getString("thursdayLectures", "");  //Get the string value from file
        String strFinishedLectures = preference.getString("finishedLecturesThursday", "");  //Get the string value from file
    ...
    private void initializeArrayList() {    //Add initial values to the ArrayList
        ...
        lecturesArrayList.add(new Lecture("ML","8:00 - 9:20"));
        lecturesArrayList.add(new Lecture("Android", "9:30 - 10:40"));
    }
    //_____________________________________________________________________________________________________________________________________
    ...
    private void setupViews() { //Setup the needed elements that we will need in this class
        ...
        dayImage.setImageResource(R.drawable.thursday);
    ...
    public void btnFinishedOnClickDay(View view) {    //To save the finished lectures in the editor file
        ...
        editor.putString("finishedLecturesThursday", finishedLecturesString);   //Put Json String in the editor file
        editor.commit();    //Save changes
    ...
    public void btnLoadOnClickDay(View view) {     //To load the number of finished lectures using preference and gson
        String str = preference.getString("finishedLecturesThursday", "");  //Get the string value from file
